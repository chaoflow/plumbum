...
from plumbum.cli.completion import CompletionMixin, completion, Completion, DynamicCompletion
from plumbum.cli.completion import FileCompletion, DirectoryCompletion, ListCompletion, CallbackDynamicCompletion
